                ...
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="POST" action="{{route('admin.manufacture.store')}}" novalidate="novalidate">
                                	@csrf
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">Manufacture Name <strong style="color: red">*</strong></label>
                                        <div class="col-lg-10">
                                            <input class=" form-control" id="name" name="manufacture_name" type="text" required="" aria-required="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control " id="ccomment" name="manufactures_description" required="" aria-required="true"></textarea>
                                        </div>
                                    </div>
